...
$hx_exports["invoices"] = $hx_exports["invoices"] || {};
...
class invoices_Invoices {
	...
	registerMyMethods() {
		let bus = this.maglev;
		this.maglev.register("Invoices.CreateInvoice",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.CreateInvoice"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.CreateInvoice' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.DeleteInvoice",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.DeleteInvoice"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.DeleteInvoice' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.ChangeInvoice",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.ChangeInvoice"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.ChangeInvoice' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.GetInvoiceSummary",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.GetInvoiceSummary"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.GetInvoiceSummary' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.GetLineItems",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.GetLineItems"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.GetLineItems' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.AddLineItem",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.AddLineItem"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.AddLineItem' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.ChangeLineItem",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.ChangeLineItem"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.ChangeLineItem' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.RemoveLineItem",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.RemoveLineItem"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.RemoveLineItem' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.GetInvoicesByClient",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.GetInvoicesByClient"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.GetInvoicesByClient' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.GetAllInvoices",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.GetAllInvoices"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.GetAllInvoices' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("Invoices.FindInvoiceByNumber",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("Invoices.FindInvoiceByNumber"));
			data.push(maglev_MagLevString.fromString("invoices"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'Invoices.FindInvoiceByNumber' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
	}
}
$hxClasses["invoices.Invoices"] = $hx_exports["invoices"]["Invoices"] = invoices_Invoices;
invoices_Invoices.__name__ = "invoices.Invoices";
Object.assign(invoices_Invoices.prototype, {
	__class__: invoices_Invoices
	,maglev: null
});
class js_Boot {
	static isClass(o) {
...
var invoices = $hx_exports["invoices"];
